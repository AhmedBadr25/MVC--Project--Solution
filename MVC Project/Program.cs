namespace MVC_Project
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    optionBuilder.UseSqlServer("Server=DESKTOP-A1088VT\\ABDOHAMDY;Database=mvc;Trusted_Connection=true;TrustServerCertificate=true");
            ...
            if (!app.Environment.IsDevelopment())
            {
                ...
                // The default HSTS value is 30 days. You may want to change this for production scenarios, see https://mvc.ms/aspnetcore-hsts.
                app.UseHsts();
            }
